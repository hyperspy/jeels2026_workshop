...
@app.cell
def _(hs):
    # Load the EELS data file:
    # TODO: use hs.load() with "../2 - EELS/datasets/CuZn_EELS_mapping_tutorial.hspy"
    s = None  # Replace with hs.load(...)
    s
    return (s,)
...
@app.cell
def _(s):
    # TODO: Get the scale of the energy axis
...
@app.cell
def _(s):
    # TODO: Get the units of the energy axis
...
@app.cell
def _(s):
    # TODO: Use inav to select the central navigation position and plot it
...
@app.cell
def _(s):
    # TODO: Use isig to zoom into a signal range (e.g. 930 to 1005 eV)
...
def _(hs, plt, roi_cu, s):
    ...
    # Use plot_roi_map with two SpanROIs:
